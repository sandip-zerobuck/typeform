...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h4 class="panel-title">Header - Order Product Details</h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var table = $('#table').dataTable( {
            ...
            "sAjaxSource": '<?=BASE_URL_ADMIN.'ordermaster/ordermaster/datatableorderproductdetails/'.$this->uri->segment(5)?>',
            // "bJQueryUI": true,
