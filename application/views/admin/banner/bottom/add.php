...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>banner/bottom/store" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="col-md-4">
					...
					<label class="control-label">Banner Name <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="text" name="name" placeholder="Eneter Banner Name" class="form-control" value="<?=set_value('name'); ?>">
			...
			<div class="form-group">
				...
				<a href="<?=BASE_URL_ADMIN?>banner/bottom" class="btn btn-danger">Cancel</a>
			</div>
		</form>
	</div>
</div>
