...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h4 class="panel-title">Edit Link Ads</h4>
		<div class="heading-elements"></div><br>
	</div>

	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>non_user/linkads/Link/update" enctype="multipart/form-data" class="form-horizontal">
			...
			<input type="hidden" name="id" value="<?=$result->id?>" />
				...
				<div class="form-group col-md-12">
					...
					<a href="<?=BASE_URL_ADMIN.'non_user/linkads/Link'?>" class="btn btn-danger">Cancel</a>
				</div>
