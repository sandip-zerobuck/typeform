...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h4 class="panel-title">Edit Middel Ads</h4>
		<div class="heading-elements"></div><br>
	</div>

	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>non_user/banner/Middel/update" enctype="multipart/form-data" class="form-horizontal">
					...
					<br>
						...
						<div class="multi-select-full">
							<br>
								...
								<a href="<?=BASE_URL_ADMIN.'non_user/banner/Middel'?>" class="btn btn-danger">Cancel</a>	
						</div>
