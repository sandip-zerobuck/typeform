...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h4 class="panel-title">State Master</h4>
...
<script type="text/javascript" src="<?=base_url()?>assets/admin/js/pages/datatables_basic.js"></script>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var table = $('#table').dataTable( {
            ...
            "ajax": {
                "url": "<?=BASE_URL_ADMIN?>areamaster/statemaster/datatable",
                "type": "POST"
            },
            // "bJQueryUI": true,
