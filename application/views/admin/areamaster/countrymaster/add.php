...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>areamaster/countrymaster/store" enctype="multipart/form-data" class="form-horizontal">
			<div class="form-group">
				<label class="col-md-2 control-label">Country Name : <span class="text-danger">*</span></label>
				<div class="col-md-10">
					<input type="text" name="name" class="form-control" placeholder="Enter Country Name" value="<?=set_value('name'); ?>">
			...
			<div class="form-group">
				...
				<a href="<?=BASE_URL_ADMIN.'areamaster/countrymaster/'?>" class="btn btn-danger">Cancel</a>
			</div>
		</form>
	</div>
</div>
