...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h4 class="panel-title">Edit Pincode</h4>
		<div class="heading-elements"></div><br>
	</div>

	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>areamaster/pincodemaster/update" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-md-2 control-label">Taluka Name : <span class="text-danger">*</span></label>
				<div class="col-md-10">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" name="pincode" class="form-control" value="<?=$result->pincode?>">
