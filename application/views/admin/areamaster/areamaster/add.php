...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>areamaster/areamaster/store" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-md-2 control-label">Select Taluka : <span class="text-danger">*</span></label>
				<div class="col-md-10">
