...
<div class="panel panel-flat">
	...
	<div class="panel-heading">
		<h4 class="panel-title">Waiting Image Ads</h4>
...
<form method="post" action="<?=BASE_URL_ADMIN?>campingmaster/imagemaster/export_excel_waiting">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var table = $('#table').dataTable( {
            ...
            "ajax": {
                "url": "<?=BASE_URL_ADMIN?>campingmaster/imagemaster/datatable_waiting",
                "type": "POST"
            },
