...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>campingmaster/videomaster/update" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="col-md-4">
					...
					<label class="control-label">Video Coin <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							...
							<input type="text" min="1" name="coin"  placeholder="Eneter Video Coin" class="form-control number" value="<?=$result->coin?>">
