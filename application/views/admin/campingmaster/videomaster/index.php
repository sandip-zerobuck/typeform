...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h4 class="panel-title">Header - Runnign Video Ads</h4>
        <div class="heading-elements">
            <a href="<?=BASE_URL_ADMIN?>campingmaster/videomaster/add" class="btn btn-primary">Add</a>      
        </div><br>

<form method="post" action="<?=BASE_URL_ADMIN?>campingmaster/videomaster/export_excel_running">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var table = $('#table').dataTable( {
            ...
            "sAjaxSource": '<?=BASE_URL_ADMIN?>campingmaster/videomaster/datatable_running',
            // "bJQueryUI": true,
