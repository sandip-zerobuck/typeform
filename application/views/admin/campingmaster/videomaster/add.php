...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>campingmaster/videomaster/store" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<label class="control-label">Video Title <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="text" name="name" placeholder="Eneter Video Title" class="form-control" value="<?=set_value('name'); ?>">
				...
				<div class="col-md-4">
					...
					<label class="control-label">Video Coin <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="text" min="1" name="coin"  placeholder="Eneter Video Coin" class="form-control number" value="<?=set_value('name'); ?>">

							<!-- <input type="hidden"  name="coin"   value="<?=$coin_rate->video?>"> -->
				...
				<div class="col-md-4">
					...
					<label class="control-label">Video Click <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="number" min="1" name="click" placeholder="Eneter Video Click" class="form-control" value="<?=set_value('click'); ?>">
				...
				<div class="col-md-4">
					...
					<label class="control-label">Video Timer <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="number" min="1" name="timer" placeholder="Eneter Video Timer" class="form-control" value="<?=set_value('timer'); ?>">
