...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h4 class="panel-title">Running App Download Link Ads</h4>
        <div class="heading-elements">
            <a href="<?=BASE_URL_ADMIN?>campingmaster/applinkmaster/add" class="btn btn-primary">Add</a>      
        </div><br>

<form method="post" action="<?=BASE_URL_ADMIN?>campingmaster/applinkmaster/export_excel_running">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var table = $('#table').dataTable( {
            ...
            "sAjaxSource": '<?=BASE_URL_ADMIN?>campingmaster/applinkmaster/datatable_running',
            // "bJQueryUI": true,
