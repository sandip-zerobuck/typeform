...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h4 class="panel-title">Waiting Link Ads</h4>
        <div class="heading-elements">
            <a href="<?=BASE_URL_ADMIN?>campingmaster/linkmaster/add" class="btn btn-primary">Add</a>      
        </div><br>

<form method="post" action="<?=BASE_URL_ADMIN?>campingmaster/linkmaster/export_excel_waiting">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var table = $('#table').dataTable( {
            ...
            "sAjaxSource": '<?=BASE_URL_ADMIN?>campingmaster/linkmaster/datatable_waiting',
            // "bJQueryUI": true,
