...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>notification/update" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					...
					<textarea class="form-control" name="message" placeholder="Enter Message"><?=$result->message?></textarea>
			...
			<div class="form-group">
				...
				<a href="<?=BASE_URL_ADMIN.'notification/'?>" class="btn btn-danger">Cancel</a>
			</div>
		</form>
	</div>
</div>
