...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h4 class="panel-title"> <b>Image Ads Report</b></h4>
        <h4 class="panel-title"> <b>Ads Name :</b> <?=$result->name?></h4>
        <div class="heading-elements">
            <form method="post" action="<?=BASE_URL_ADMIN?>ads_report/Image/export_excel/<?=$result->id?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var table = $('#table').dataTable( {
            ...
            "sAjaxSource": '<?=BASE_URL_ADMIN?>ads_report/Image/datatable/<?=$result->id?>',
            // "bJQueryUI": true,
