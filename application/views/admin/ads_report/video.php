...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h4 class="panel-title"> <b>Video Ads Report</b></h4>
        <h4 class="panel-title"> <b>Ads Name :</b> <?=$result->name?></h4>
        <div class="heading-elements">
            <form method="post" action="<?=BASE_URL_ADMIN?>ads_report/Video/export_excel/<?=$result->id?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        var table = $('#table').dataTable( {
            ...
            "sAjaxSource": '<?=BASE_URL_ADMIN?>ads_report/Video/datatable/<?=$result->id?>',
            // "bJQueryUI": true,
