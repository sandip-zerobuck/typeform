...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>transfercharge/update" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-md-2 control-label">Charge : <span class="text-danger">*</span></label>
				<div class="col-md-10">
					<input type="text" name="charge" class="form-control" value="<?=$result->charge?>">
			...
			<div class="form-group">
				...
				<a href="<?=BASE_URL_ADMIN.'transfercharge/'?>" class="btn btn-danger">Cancel</a>
			</div>
		</form>
	</div>
</div>
