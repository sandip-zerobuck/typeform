...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>adsuser/request/image/update" enctype="multipart/form-data" class="form-horizontal">

			<input type="hidden" name="id" value="<?=$result->id?>" />
			<input type="hidden" name="old_image" value="<?=$result->image?>" />

			<input type="hidden" name="date_status" value="<?=$result->date_status?>" />
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<label class="control-label">Image Title <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="text" name="name" placeholder="Eneter Image Title" class="form-control" value="<?=$result->name?>">
				...
				<div class="col-md-4">
					...
					<label class="control-label">Image Coin <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="number" min="1" name="coin" placeholder="Eneter Image Coin" class="form-control" value="<?=$result->coin?>">
				...
				<div class="col-md-4">
					...
					<label class="control-label">Image Click <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="number" min="1" name="click" placeholder="Eneter Image Coin" class="form-control" value="<?=$result->click?>">
				...
				<div class="col-md-4">
					...
					<label class="control-label">Image Timer <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="number" min="1" name="timer" placeholder="Eneter Image Timer" class="form-control" value="<?=$result->timer?>">
			...
			<div class="form-group">
				...
				<a href="<?=BASE_URL_ADMIN.'adsuser/request/image'?>" class="btn btn-danger">Cancel</a>
			</div>
		</form>
	</div>
</div>
