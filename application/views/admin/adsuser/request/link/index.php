...
<div class="panel panel-flat">
	...
	<div class="panel-heading">
		<h4 class="panel-title">link Ads Request</h4>
...
<form method="post" action="<?=BASE_URL_ADMIN?>campingmaster/linkmaster/export_excel_running">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var table = $('#table').dataTable( {
            ...
            "ajax": {
                "url": "<?=BASE_URL_ADMIN?>adsuser/request/Link/datatable",
                "type": "POST"
            },
            ...
            "iDisplayStart ":20,
            "oLanguage": {
            // "sProcessing": "<img src='<?php //echo base_url(); ?>assets/links/ajax-loader_dark.gif'>"
            },      
