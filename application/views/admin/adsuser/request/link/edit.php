...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>adsuser/request/link/update" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				...
				<a href="<?=BASE_URL_ADMIN.'adsuser/request/Link'?>" class="btn btn-danger">Cancel</a>
			</div>
		</form>
	</div>
</div>
