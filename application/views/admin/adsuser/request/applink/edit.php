...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>adsuser/request/applink/update" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<br>
					<label class="control-label">App Link URL <span class="text-danger">*</span></label>
				...
				<div class="col-md-4">
					...
					<label class="control-label">Link Coin <span class="text-danger">*</span></label>
						...
						<div class="multi-select-full">
							<input type="number" min="1" name="coin" placeholder="Eneter Link Coin" class="form-control" value="<?=$result->coin?>">
			...
			<div class="form-group">
				...
				<a href="<?=BASE_URL_ADMIN.'adsuser/request/applink'?>" class="btn btn-danger">Cancel</a>
			</div>
		</form>
	</div>
</div>
