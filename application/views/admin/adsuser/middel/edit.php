...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>adsuser/banner/middel/update" enctype="multipart/form-data" class="form-horizontal">
					...
					<br>
						...
						<div class="multi-select-full">
							<br>
								...
								<a href="<?=BASE_URL_ADMIN.'adsuser/banner/Middel'?>" class="btn btn-danger">Cancel</a>	
						</div>
