...
<div class="panel panel-flat">
	...
	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>draw/index/store" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				<b class="col-md-2 control-label">Winners User : <span class="text-danger">*</span></b>
				<div class="col-md-4">
					<input type="number" name="winners_user" class="form-control" placeholder="Winners User" value="<?=set_value('winners_user'); ?>">
					<?=form_error('winners_user', '<div class="text-danger">', '</div>'); ?>
				</div>
			</div>
			...
			<div class="form-group">
				<b class="col-md-2 control-label">Image: <span class="text-danger">* (430px * 315px)</span></b>
				<div class="col-md-4">
