...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h4 class="panel-title">Add Product Image</h4>
		<div class="heading-elements"></div><br>
	</div>

	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>shop/Product_image/store" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				...
				<a href="<?=BASE_URL_ADMIN.'shop/Product_image/index/'.$id?>" class="btn btn-danger">Cancel</a>
			</div>
		</form>
	</div>
</div>
