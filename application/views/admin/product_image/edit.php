...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h4 class="panel-title">Edit Product Image</h4>
		<div class="heading-elements"></div><br>
	</div>

	<div class="panel-body">
		<form method="post" action="<?=BASE_URL_ADMIN?>shop/Product_image/update" enctype="multipart/form-data" class="form-horizontal">
