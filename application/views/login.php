                    ...
                    <form action="<?=base_url()?>login/authenticate" method="post">
                        <div class="panel panel-body login-form">
                            <div class="text-center">
                                <h5 class="content-group">User Login <small class="display-block">Enter your credentials below</small></h5>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?=base_url()?>signup" class="btn btn-danger btn-block">SignUp <i class="icon-circle-right2 position-right"></i></a>
                            </div>
                        </div>
                    </form>
                    <!-- /simple login form -->
